package com.rakbank.paymentservice.core.constants;
...
public class Errors {
    ...
    public final static String PURCHASE_NOT_FOUND= "1004:404:Purchase not found.";
    public final static String TRANSACTION_NOT_FOUND= "1005:404:Transaction not found.";
